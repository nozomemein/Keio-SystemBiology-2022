...
p coding.return_binary_codings
...
ga_normal = GeneticAlgorithm.new(sample_num:SAMPLE_NUM,gtype_length: GTYPE_LENGTH,generation:GENERATION,coding_table:coding.return_binary_codings)
ga_normal.ga_flow()
puts "*"*100+"\n\n"
